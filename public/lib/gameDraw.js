...
var gameDraw = {
  ...
  modifyColor: (color, base = "16 0 1 0 false") => {
    ...
    // Get HSL values
    let baseColor = gameDraw.rgbToHsl(
      gameDraw.getColor(colorDetails[0]) ?? colorDetails[0]
    );
    ...
    // Gaming.
    let finalColor = gameDraw.hslToRgb(
      finalHue,
      finalSaturation,
      finalBrightness
    );
    if (!gameDraw.animatedColors[colorDetails[0]])
      gameDraw.colorCache[colorId] = finalColor;
    return finalColor;
  },
  ...
  reanimateColors: () => {
    ...
    gameDraw.animatedColor.lesbian = gameDraw.getRainbow(
    ...
    gameDraw.animatedColor.blue_red = blinker
      ? gameDraw.color.blue
      : gameDraw.color.red;
    gameDraw.animatedColor.blue_grey = blinker
      ? gameDraw.color.blue
      : gameDraw.color.grey;
    gameDraw.animatedColor.grey_blue = blinker
      ? gameDraw.color.grey
      : gameDraw.color.blue;
    gameDraw.animatedColor.red_grey = blinker
      ? gameDraw.color.red
      : gameDraw.color.grey;
    gameDraw.animatedColor.grey_red = blinker
      ? gameDraw.color.grey
      : gameDraw.color.red;
  },
  animatedColors: {
  ...
  getColorDark: (givenColor) => {
    let dark = settings.graphical.neon
      ? gameDraw.color.white
      : gameDraw.color.black;
