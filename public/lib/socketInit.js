...
var serverStart = 0,
  gui = {
    ...
    __s: {
      ...
      getProgress: () =>
        levelscore
          ? Math.min(1, Math.max(0, (sscore.get() - deduction) / levelscore))
          : 0,
      getScore: () => sscore.get(),
      getLevel: () => level,
    },
    ...
    switch (m.shift()) {
      ...
      case "S": // clock syncing
        ...
        if (sync.length < 10) {
          ...
          global.message =
            "Syncing clocks, please do not tab away. " + sync.length + "/10...";
        } else {
          ...
          console.log(sync);
          console.log(
            "Syncing complete, calculated clock difference " + clockDiff + "ms."
          );
