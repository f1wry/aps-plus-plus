  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          { recoil: 1.4 },
          g.turret,
          { health: 1.8, speed: 0.4, maxSpeed: 0.4, reload: 0.5 },
        ]),
        TYPE: "bullet",
      },
    },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          { recoil: 1.4 },
          g.turret,
          { health: 1.55, speed: 0.4, maxSpeed: 0.4, reload: 0.5 },
        ]),
        TYPE: "bullet",
      },
    },
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          ...
          { recoil: 1.4 },
          g.turret,
          { health: 1.4, speed: 0.4, maxSpeed: 0.4, reload: 0.5 },
        ]),
        TYPE: "bullet",
      },
    },
...
Class.turretedTrap = makeAuto("trap", "Auto-Trap", {
  size: 7.5,
  ...
  GUNS: [
    {
      ...
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([
          g.basic,
          g.minionGun,
          { health: 0.45, speed: 0.8, maxSpeed: 0.8 },
        ]),
        WAIT_TO_CYCLE: true,
        TYPE: "bullet",
      },
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.dreadv1Generic,
            g.dreadv1Slow,
            { speed: 0.8, maxSpeed: 0.8, range: 0.75, size: 0.55 },
          ]),
          TYPE: "bullet",
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.dreadv1Generic,
            g.dreadv1Slow,
            { speed: 0.8, maxSpeed: 0.8, range: 0.75, size: (0.55 * 8) / 7.5 },
          ]),
          TYPE: "bullet",
        },
      },
...
for (let primary of Class.dreadOfficialV1.UPGRADES_TIER_1) {
  ...
  for (let secondary of t1Bodies) {
    ...
    if (secondary.BODY)
      for (let m in secondary.BODY) BODY[m] *= secondary.BODY[m];
