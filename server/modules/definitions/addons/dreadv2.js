      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.twin,
            g.spam,
            { size: 0.6, health: 0.95, reload: 1.1 },
          ]),
          TYPE: "bullet",
        },
      },
    ...
    [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.overseer,
            g.overseer,
            { maxSpeed: 0.9, size: 1.5, reload: 1.4 },
          ]),
          TYPE: "drone",
          MAX_CHILDREN: 2,
          AUTOFIRE: true,
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.overseer,
            g.pounder,
            { damage: 0.85, maxSpeed: 0.9, size: 2, reload: 1.4 },
          ]),
          TYPE: "betadrone",
          MAX_CHILDREN: 2,
          AUTOFIRE: true,
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.spam,
            g.spam,
            { size: 0.65, health: 1.33, reload: 1.1 },
          ]),
          TYPE: "bullet",
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.spam,
            g.spam,
            { size: 0.7, health: 1.33, reload: 1.2 },
          ]),
          TYPE: "bullet",
        },
      },
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            ...
            g.overseer,
            g.pounder,
            { damage: 1.04, maxSpeed: 0.9, size: 2, reload: 1.2 },
          ]),
          TYPE: "betadrone",
          MAX_CHILDREN: 1,
          AUTOFIRE: true,
