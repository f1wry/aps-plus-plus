...
console.log(
  "Loaded definitions in " +
    (definitionGroupsLoadEnd - definitionGroupsLoadStart) +
    " milliseconds. \n"
);
...
console.log(
  "Loaded addons in " +
    (addonsLoadEnd - definitionGroupsLoadEnd) +
    " milliseconds. \n"
);
...
console.log(
  `Combined ${groups.length} definition groups and ${
    loadedAddons.length
  } addons into ${definitionCount} ${
    Config.flattenDefintions ? "flattened " : ""
  }definitions!\n`
);
