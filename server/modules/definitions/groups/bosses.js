  ...
  ON: [
    {
      ...
      handler: ({ body }) => {
        ...
        if (spawnSentries)
          new Entity(body, body).define(
            sentries[Math.floor(Math.random() * sentries.length)]
          );
      },
    },
    {
...
const trebuchetStats = [
  ...
  g.predator,
  g.predator,
  { speed: 0.93, maxSpeed: 0.93, reload: 2, health: 1.7, damage: 1.4, size: 2 },
];
const hielamanStats = [
  g.trap,
  g.setTrap,
  g.hexaTrapper,
  { reload: 2.85, health: 3.2, range: 1.2 },
];
Class.frostBoss = {
  PARENT: "miniboss",
  LABEL: "Extrasolar",
