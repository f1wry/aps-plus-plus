...
Class.spectator = {
  ...
  ARENA_CLOSER: true,
  TOOLTIP:
    "Left click to teleport, Right click above or below the screen to change FOV",
  ...
  ON: [
    ...
    },
    {
      ...
      handler: ({ body }) =>
        (body.FOV =
          body.y + body.control.target.y < body.y
            ? body.FOV + 0.5
            : Math.max(body.FOV - 0.5, 0.2)),
    },
  ],
};
...
Class.makeAutoTestTurret = makeTurret("ranger", {
  canRepel: true,
  limitFov: true,
  extraStats: { reload: 0.5 },
});
Class.makeAutoTest = {
  PARENT: "genericTank",
...
Class.bed = {
  PARENT: "genericTank",
  LABEL: "Bed",
  SHAPE: "https://cdn.glitch.global/dd1077cc-413b-413d-bed5-fde9911308ff/bed.png?v=1718507957985",
  GUNS: [
    // {
    //   POSITION: [18, 8, 1, 0, 0, 0, 0],
    //   PROPERTIES: {
...
Class.endStone = {
  PARENT: "genericTank",
  LABEL: "End Stone",
  SHAPE: "https://cdn.glitch.global/dd1077cc-413b-413d-bed5-fde9911308ff/end_stone.png?v=1718534273547",
  UPGRADE_TOOLTIP: "You wanted this...",
  GUNS: [
    // {
    //   POSITION: [18, 8, 1, 0, 0, 0, 0],
    //   PROPERTIES: {
...
Class.magma = {
  PARENT: "genericTank",
  LABEL: "Magma",
  SHAPE: "https://cdn.glitch.global/dd1077cc-413b-413d-bed5-fde9911308ff/magma.png?v=1718508747406",
  GUNS: [
    // {
    //   POSITION: [18, 8, 1, 0, 0, 0, 0],
    //   PROPERTIES: {
...
Class.bedrock = {
  PARENT: "genericTank",
  LABEL: "Bedrock",
  SHAPE: "https://cdn.glitch.global/dd1077cc-413b-413d-bed5-fde9911308ff/bedrock.png?v=1718508740321",
  GUNS: [
    // {
    //   POSITION: [18, 8, 1, 0, 0, 0, 0],
    //   PROPERTIES: {
