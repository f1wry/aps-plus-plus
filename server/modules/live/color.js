    ...
    switch (typeof color) {
      ...
      case "object":
        ...
        this.#saturationShift =
          color.SATURATION_SHIFT ?? color.saturationShift ?? 1;
        this.#brightnessShift =
          color.BRIGHTNESS_SHIFT ?? color.brightnessShift ?? 0;
        this.#allowBrightnessInvert =
          color.ALLOW_BRIGHTNESS_INVERT ?? color.allowBrightnessInvert ?? false;
        break;
      case "string":
        if (!color.includes(" ")) {
          this.#base = color;
