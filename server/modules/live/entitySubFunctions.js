...
class Skill {
  ...
  update() {
    ...
    this.shi =
      Config.GLASS_HEALTH_FACTOR *
      apply(3 / Config.GLASS_HEALTH_FACTOR - 1, attrib[skcnv.shi]);
    this.atk = apply(0.021, attrib[skcnv.atk]);
    this.hlt =
      Config.GLASS_HEALTH_FACTOR *
      apply(2 / Config.GLASS_HEALTH_FACTOR - 1, attrib[skcnv.hlt]);
  ...
  get levelPoints() {
    return this.LSPF
      ...
      : Config.LEVEL_SKILL_POINT_FUNCTION(this.level);
  }
